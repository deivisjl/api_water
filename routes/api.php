...
Route::get('estado-servicio-editar','Catalogos\EstadoServicioController@obtener_estados_editar');
...
/* Rutas de servicios */
Route::resource('servicios','Servicio\ServicioController',['except' => ['create','destroy']]); 
